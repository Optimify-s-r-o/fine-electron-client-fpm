        ...
        <Suspense fallback={<Wrapper />}>
            <Routes>
                ...
                <Route path={RoutesPath.PORTAL} element={<ProtectedRoute><Portal /></ProtectedRoute>}>
                    <Route path={RoutesPath.CREATE_PROJECT} element={<ProtectedRoute><CreateProject /></ProtectedRoute>}/>
                    <Route path={RoutesPath.CREATE_CUSTOMER} element={<ProtectedRoute><CreateCustomer /></ProtectedRoute>}/>
                    <Route path={RoutesPath.LIST_OF_CUSTOMERS} element={<ProtectedRoute><ListOfCustomers /></ProtectedRoute>}/>
