...
export const lightTheme = {
  ...
  boxShadowHalf: '0 1px 4px 0 rgba(0, 0, 0, 0.1), 0 0 2px 0 rgba(0, 0, 0, 0.05)',
  boxShadowSharp: '0 2px 4px 1px rgba(0, 0, 0, 0.15), 0px 2px 3px -1px rgba(0,0,0,0.5)',
  boxShadowSharpHover: '0 2px 8px 1px rgba(0, 0, 0, 0.15), 0px 2px 6px -1px rgba(0,0,0,0.5)',
  boxShadowSharpActive: '0 2px 16px 1px rgba(0, 0, 0, 0.2), 0px 2px 12px -1px rgba(0,0,0,0.75)'
};
...
export const darkTheme = {
  ...
  boxShadowHalf: '0 1px 4px 1px rgba(0, 0, 0, 0.1), 0 0 2px 1px rgba(0, 0, 0, 0.5)',
  boxShadowSharp: '0 2px 4px 1px rgba(0, 0, 0, 0.15), 0px 2px 3px -1px rgba(0,0,0,.5)',
  boxShadowSharpHover: '0 2px 8px 1px rgba(0, 0, 0, 0.15), 0px 2px 6px -1px rgba(0,0,0,.5)',
  boxShadowSharpActive: '0 2px 16px 1px rgba(0, 0, 0, 0.2), 0px 2px 12px -1px rgba(0,0,0,.75)'
};
