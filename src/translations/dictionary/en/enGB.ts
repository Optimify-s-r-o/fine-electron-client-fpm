...
const dictionary: Lang = {
  ...
  remove: {
    ...
    customerHasProject: 'Customer "{name}" is assigned to the project. Cannot be deleted.',
  ...
  carousel: {
    ...
    text4: 'Active desktop with local menus. New graphic selections. Trace objects as you type.',
  ...
  common: {
    ...
    notAdmin: 'Only the organization administrator can edit the organization information.',
    ...
    CannotDeleteDefaultPriceListItem: 'It is not possible to delete the default item.',
    CannotDeleteDefaultTemplate: 'It is not possible to delete the default template.',
    ...
    IsNotOrganizationAdmin: 'The action failed. You do not have administrator privileges.',
    CloudOnly: 'Cloud version only.',
    NeedToSetEmail: 'Email is required.',
    NewPasswordSameAsOld: 'The new password must be different from the original password.',
    ...
    CannotContainValueCharacter: 'Must not contain the following characters: (,), $',
    ...
    closeWithoutSavingTitle: 'Are you sure you want to leave the page without saving?',
    ...
    BadCustomerType: 'Customer type does not match customer in database (It may have been changed)',
    ...
    FileNotExists: 'The specified file does not exist (It may have been deleted)',
    ...
    MissingTrussFile: 'Truss file not found. (It may have been deleted manually)',
    ...
    IsTemporaryWithoutTrussData: 'Unable to open job. It is probably being edited by another user.',
    ...
    PasswordRequiresNonAlphanumeric: 'Password cannot contain numeric characters.',
    PasswordRequiresDigit: 'The password requires at least one numeric character.',
    ...
    averagePlatesWeighOnPlanksVolume: 'Average weight of plates per volume of planks',
    ...
    productionsPerQuotationsFilter: 'Ratio of implemented and unrealized projects',
    ...
    tooltip: {
      columnSelectorDisabled: 'The column cannot be removed due to a sort application.',
      ...
      filtered: 'Filters are active - matches {{totalRecords}} of {{recordsBeforeFilter}} records.'
    }
  },
  settings: {
